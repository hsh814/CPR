...
def main():
    ...
    parser.add_argument("cmd", help="Command to run", choices=["fuzz", "fuzz-seeds", "check", "fuzz-build", "val-build", "build", "extractfix-build", "vulmaster-build", "collect-inputs", "group-patches", "val", "feas", "analyze"])
