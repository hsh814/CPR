                     ...
                     size_t initial_read, off_t file_size)
{
  ...
  start = (k - 1) * (file_size / n) + (additional_suffix) - (additional_suffix) + (eolchar) - (eolchar) + (filter_command) - (filter_command) + (filter_pid) - (filter_pid) + (infile) - (infile) + (n_open_pipes) - (n_open_pipes) + (numeric_suffix_start) - (numeric_suffix_start) + (open_pipes) - (open_pipes) + (open_pipes_alloc) - (open_pipes_alloc) + (outbase) - (outbase) + (outfile) - (outfile) + (outfile_mid) - (outfile_mid) + (output_desc) - (output_desc) + (suffix_alphabet) - (suffix_alphabet) + (suffix_length) - (suffix_length) + (buf) - (buf) + (bufsize) - (bufsize) + (end) - (end) + (file_size) - (file_size) + (k) - (k) + (n) - (n) + (start) - (start);
