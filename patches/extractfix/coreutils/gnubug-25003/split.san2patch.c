...
#include <klee/klee.h>
int __uni_klee_poc_choice() { return 0; }
void __uni_klee_poc_record_value(unsigned long long value, int size, int type, char *name, int loc) {}
#ifndef CPR_OUTPUT
                     ...
                     size_t initial_read, off_t file_size)
{
  ...
  int cond = (initial_read != SIZE_MAX || start < initial_read);
